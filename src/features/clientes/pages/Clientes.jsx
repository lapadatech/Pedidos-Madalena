...
function Clientes() {
  ...
  const checkCelular = useCallback(
    async (celular) => {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    />
                    {celularExistente && (
                      <div className="absolute top-full mt-1 flex items-center text-sm text-red-500">
                ...
                <div className="space-y-4 border-t pt-4">
                  ...
                  <div className="space-y-4">
                    {formData.enderecos.map((end, index) => (
                      <div key={end.id} className="p-4 border rounded-md relative space-y-4">
                        <Button
                          type="button"
                          variant="ghost"
                          size="icon"
                        ...
                        <Button
                          type="button"
                          variant={end.principal ? 'default' : 'outline'}
                          size="sm"
                          className="gap-2"
                        ...
                        >
                          <Star
                            className={`h-4 w-4 ${end.principal ? 'text-yellow-400 fill-yellow-400' : ''}`}
                          />{' '}
                          {end.principal ? 'Endereço Principal' : 'Marcar como Principal'}
                        </Button>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex gap-2 pt-4 border-t">
                  ...
                  <Button
                    type="submit"
                    disabled={isSaving || celularExistente}
