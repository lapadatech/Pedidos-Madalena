                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 mt-1">
                        {formData.grupos_complementos.map((grupoId, index) => (
                          <div key={index} className="flex items-center gap-2">
                            <Select
                              value={grupoId.toString()}
                              onValueChange={(value) => handleComplementoChange(index, value)}
                              disabled={isSaving}
                            >
                              <SelectTrigger>
                            ...
                            <Button
                              ...
                              variant="ghost"
                              size="icon"
                              onClick={() => removerGrupoComplemento(index)}
                              disabled={isSaving}
                            >
                        ...
                        <Button
                          ...
                          variant="outline"
                          className="w-full"
                          onClick={adicionarGrupoComplemento}
                          disabled={isSaving}
                        >
                          <Plus className="h-4 w-4 mr-2" />
                          Adicionar Grupo
                      ...
                      <div>
                        ...
                        {complementosProduto && complementosProduto.length > 0 && (
                          <div className="mb-3">
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                              {complementosProduto.map((nome, index) => (
                                <span
                                  key={index}
