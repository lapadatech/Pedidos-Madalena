...
export const SupabaseAuthProvider = ({ children }) => {
  ...
  const initializeUser = useCallback(async (currentSession) => {
    try {
      setLoading(true);
  ...
  const temPermissao = useCallback((modulo, acao) => {
    ...
    if (typeof permissoesModulo === 'object') {
        if (acao === 'visualizar') return !!permissoesModulo.visualizar || !!permissoesModulo.editar || !!permissoesModulo.gerenciar;
