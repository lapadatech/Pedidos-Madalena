...
const SkeletonCard = () => (
  ...
  >
    ...
    <div className="pt-2 space-y-2">
      <div style={{ height: "16px", width: "50%", background: "#D1D5DB", borderRadius: "4px" }}></div>
      <div style={{ height: "16px", width: "33%", background: "#D1D5DB", borderRadius: "4px" }}></div>
      <div style={{ height: "20px", width: "25%", background: "#9CA3AF", borderRadius: "4px" }}></div>
    </div>

    <div className="flex gap-2 pt-2">
      <div style={{ height: "20px", width: "64px", background: "#D1D5DB", borderRadius: "999px" }}></div>
    </div>
  </div>
);
...
function PedidosKanban({ pedidos, onAbrirDetalhe, loading }) {
  ...
  return (
    <div className="flex gap-2 overflow-x-auto pb-4">
      <KanbanColumn title="Hoje" pedidos={colunas.hoje} onAbrirDetalhe={onAbrirDetalhe} loading={loading} />
      <KanbanColumn title="Amanhã" pedidos={colunas.amanha} onAbrirDetalhe={onAbrirDetalhe} loading={loading} />
      <KanbanColumn
