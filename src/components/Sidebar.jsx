...
import { LayoutDashboard, Users, Package, ShoppingCart, Settings, ChevronLeft, ChevronRight, Loader2 } from 'lucide-react';
...
function Sidebar({ collapsed, setCollapsed }) {
  ...
  const visibleItems = loading ? [] : menuItems.filter(item => {
      ...
      <div className="p-4 flex items-center justify-center border-b border-gray-200 relative">
        {!collapsed && (
          <div className="flex flex-col items-center">
            <img src="https://horizons-cdn.hostinger.com/e36d36b8-0bd5-4763-9879-98322153d8ad/0e924da8366373d07b6cb40d5e5f3b9a.png" alt="Madalena Brigadeiros Logo" className="h-20" />
