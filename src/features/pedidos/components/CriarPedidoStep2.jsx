  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-2">
          <Button
            ...
            className={tipoEntrega === 'retirada' ? 'bg-orange-500 hover:bg-orange-600' : ''}
          >
            Retirada
          </Button>
          <Button
            ...
            className={tipoEntrega === 'entrega' ? 'bg-orange-500 hover:bg-orange-600' : ''}
          >
            Entrega
          </Button>
        </div>
            ...
            <div className="space-y-2">
              {enderecosCliente.map((endereco) => (
                <div
                  ...
                  className={`p-3 border rounded-lg cursor-pointer transition-all ${enderecoSelecionado === endereco.id ? 'border-orange-500 bg-orange-50' : 'border-gray-200 hover:border-orange-300'}`}
                >
              ...
              {enderecosCliente.length === 0 && !mostrarNovoEndereco && (
                <p className="text-sm text-center text-gray-500 p-4 bg-gray-50 rounded-lg">
      ...
      <div className="flex gap-2 pt-4">
        ...
        <Button onClick={handleProximo} className="flex-1 bg-orange-500 hover:bg-orange-600">
          Próximo
        </Button>
      </div>
    </div>
