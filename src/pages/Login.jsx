...
function Login() {
  ...
  const {
    signIn
  } = useAuth(); // Usando signIn do SupabaseAuthContext
  ...
  const handleSubmit = async e => {
    ...
    const {
      error
    } = await signIn(email, senha); // Usando signIn do Supabase
        ...
        y: 0
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full bg-orange-500 hover:bg-orange-600" disabled={carregando}>
